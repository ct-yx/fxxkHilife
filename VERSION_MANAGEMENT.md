...
- **v2.2.0** (versionCode=13, 2026-06-28)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=13, versionName="2.2.0" |
| `app/src/main/res/values/strings.xml` | version_name=2.2.0 |
| `README.md` | v2.2.0 |
| `README_EN.md` | v2.2.0 |
| `DEVELOPMENT_LOG.md` | v2.2.0 (末尾) |
