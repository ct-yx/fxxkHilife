...
## 当前版本
- **v2.9.5** (versionCode=36, 2026-06-29)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=36, versionName="2.9.5" |
| `app/src/main/res/values/strings.xml` | version_name=2.9.5 |
| `README.md` | v2.9.5 |
| `README_EN.md` | v2.9.5 |
| `DEVELOPMENT_LOG.md` | v2.9.5 (末尾) |
