...
## 当前版本
- **v2.12.2** (versionCode=43, 2026-06-29)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=43, versionName="2.12.2" |
| `app/src/main/res/values/strings.xml` | version_name=2.12.2 |
| `README.md` | v2.12.2 |
| `README_EN.md` | v2.12.2 |
| `DEVELOPMENT_LOG.md` | v2.12.2 (末尾) |
