...
| # | 文件 | 字段 | 当前值 | 更新方式 |
|---|------|------|--------|----------|
| 1 | `app/build.gradle.kts` | `versionCode` | `14` | 直接修改数字 |
| 2 | `app/build.gradle.kts` | `versionName` | `"v1.7.1"` | 直接修改字符串 |
| 3 | `app/src/main/res/values/strings.xml` | `<string name="version_name">` | `"v1.7.1"` | 直接修改字符串 |
| 4 | `app/src/main/res/values-zh-rCN/strings.xml` | `<string name="version_name">` | `"v1.7.1"` | 直接修改字符串 |
| 5 | `README.md` | "当前版本：\*\*v1.7.1\*\*" | `v1.7.1` | 直接修改文本 |
| 6 | `README_EN.md` | "Current version: \*\*v1.7.1\*\*" | `v1.7.1` | 直接修改文本 |
...
- **基础**: 基于 `main` 分支的 `v1.6.8` 代码，新增 `native-daemon/` 目录
...
|------|------|-------------------------------|
| App 代码 | 完整 v1.6.5 | 同 main（通过 merge 同步） |
