...
## 当前版本
- **v2.9.2** (versionCode=33, 2026-06-29)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=33, versionName="2.9.2" |
| `app/src/main/res/values/strings.xml` | version_name=2.9.2 |
| `README.md` | v2.9.2 |
| `README_EN.md` | v2.9.2 |
| `DEVELOPMENT_LOG.md` | v2.9.2 (末尾) |
