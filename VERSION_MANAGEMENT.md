...
## 当前版本
- **v2.12.1** (versionCode=42, 2026-06-29)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=42, versionName="2.12.1" |
| `app/src/main/res/values/strings.xml` | version_name=2.12.1 |
| `README.md` | v2.12.1 |
| `README_EN.md` | v2.12.1 |
| `DEVELOPMENT_LOG.md` | v2.12.1 (末尾) |
