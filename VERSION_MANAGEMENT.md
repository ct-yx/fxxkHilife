...
## 当前版本
- **v3.0.6** (versionCode=53, 2026-06-30)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=53, versionName="3.0.6" |
| `app/src/main/res/values/strings.xml` | version_name=3.0.6 |
| `README.md` | v3.0.6 |
| `README_EN.md` | v3.0.6 |
| `DEVELOPMENT_LOG.md` | v3.0.6 (末尾) |
