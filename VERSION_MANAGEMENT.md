...
## 当前版本
- **v3.0.3** (versionCode=50, 2026-06-30)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=50, versionName="3.0.3" |
| `app/src/main/res/values/strings.xml` | version_name=3.0.3 |
| `README.md` | v3.0.3 |
| `README_EN.md` | v3.0.3 |
| `DEVELOPMENT_LOG.md` | v3.0.3 (末尾) |
