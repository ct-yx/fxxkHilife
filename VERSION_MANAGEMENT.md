...
## 当前版本
- **v3.0.2** (versionCode=49, 2026-06-30)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=49, versionName="3.0.2" |
| `app/src/main/res/values/strings.xml` | version_name=3.0.2 |
| `README.md` | v3.0.2 |
| `README_EN.md` | v3.0.2 |
| `DEVELOPMENT_LOG.md` | v3.0.2 (末尾) |
