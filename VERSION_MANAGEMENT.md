...
## 当前版本
- **v4.3.0** (versionCode=88, 2026-08-08)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=88, versionName="4.3.0" |
| `app/src/main/res/values/strings.xml` | version_name=4.3.0 |
| `README.md` | v4.3.0 |
| `README_EN.md` | v4.3.0 |
| `DEVELOPMENT_LOG.md` | v4.3.0 (末尾) |
