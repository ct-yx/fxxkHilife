...
## 当前版本
- **v2.9.6** (versionCode=37, 2026-06-29)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=37, versionName="2.9.6" |
| `app/src/main/res/values/strings.xml` | version_name=2.9.6 |
| `README.md` | v2.9.6 |
| `README_EN.md` | v2.9.6 |
| `DEVELOPMENT_LOG.md` | v2.9.6 (末尾) |
