...
## 当前版本
- **v3.6.1** (versionCode=62, 2026-06-30)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=62, versionName="3.6.1" |
| `app/src/main/res/values/strings.xml` | version_name=3.6.1 |
| `README.md` | v3.6.1 |
| `README_EN.md` | v3.6.1 |
| `DEVELOPMENT_LOG.md` | v3.6.1 (末尾) |
