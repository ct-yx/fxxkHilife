...
## 当前版本
- **v3.3.0** (versionCode=57, 2026-06-30)

## 版本号位置

| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=57, versionName="3.3.0" |
| `app/src/main/res/values/strings.xml` | version_name=3.3.0 |
| `README.md` | v3.3.0 |
| `README_EN.md` | v3.3.0 |
| `DEVELOPMENT_LOG.md` | v3.3.0 (末尾) |
