...
## 当前版本
- **当前开发包：v4.4.1** (versionCode=100, 2026-08-16；液态玻璃可见性与详情页滚动性能定向修复测试包，等待 GitHub Actions 与定向实测)
...
- 当前开发方向：v4.4.1 的 `UI_GLASS_VISIBILITY_PERF` 只验证 UI-ERR-001/002 的玻璃可见性和详情页滚动；报告返回前不标记 UI 阶段完成，也不重复 BT 全量矩阵。
...
| 位置 | 当前值 |
|------|--------|
| `app/build.gradle.kts` | versionCode=100, versionName="4.4.1" |
| `app/src/main/res/values/strings.xml` | version_name=4.4.1 |
| `README.md` | v4.4.1 |
| `README_EN.md` | v4.4.1 |
| `DEVELOPMENT_LOG.md` | v4.4.1 (末尾) |
