...
> Adds a custom monochrome earbuds + charging case vector icon and applies it to the home device list, scan results, device battery card, and app details card.
...
3. App version (v3.5.0+ logs include it automatically)
