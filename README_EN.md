...
> Starts the pluggable earbud architecture refactor with Transport / Adapter interfaces and moves Huawei handler registration out of DeviceRepository into HuaweiOpenFreebudsAdapter.
...
3. App version (v3.8.1+ logs include it automatically)
