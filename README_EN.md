...
> Polishes inline option menus and animations for gesture/device settings, redesigns the app details card, and fixes ANC mode icon centering and sizing.
...
3. App version (v3.4.0+ logs include it automatically)
