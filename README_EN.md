...
> Expands i18n facade coverage across the main user-facing UI. The log page / debug terminal intentionally keeps its original Chinese troubleshooting text for stable diagnostics.
...
3. App version (v3.3.0+ logs include it automatically)
