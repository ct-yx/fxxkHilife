...
> Continues the pluggable architecture refactor by adding RfcommSppTransport, isolating raw Android RFCOMM/SPP connection and byte I/O as a Transport layer.
...
3. App version (v3.8.2+ logs include it automatically)
