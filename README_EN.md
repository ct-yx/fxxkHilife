...
> Optimizes the GitHub Actions build/release workflow: branch pushes only build artifacts, tag builds validate version consistency before publishing, and release notes are extracted from DEVELOPMENT_LOG.
...
3. App version (v3.5.1+ logs include it automatically)
