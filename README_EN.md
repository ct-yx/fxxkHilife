...
> Fixes the home banner during core-state syncing and parses embedded SPP packets inside coalesced frames to enter the detail page faster.
...
3. App version (v3.7.1+ logs include it automatically)
