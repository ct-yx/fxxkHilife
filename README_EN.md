...
> Continues the 4.0 architecture prep work with generic Protocol interfaces plus HuaweiSppProtocol / HuaweiSppFramer, moving 5A packet encoding and stream framing into the protocol layer.
...
3. App version (v3.8.3+ logs include it automatically)
