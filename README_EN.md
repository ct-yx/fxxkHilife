...
> Optimizes core-state initialization and detail-page gating from real logs, and redesigns the device battery card with left/right earbud levels plus case level.
...
3. App version (v3.6.0+ logs include it automatically)
