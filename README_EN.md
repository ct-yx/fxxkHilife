...
> Continues slimming down SppDriver by adding HuaweiHandlerRegistry for handler lists, command routing, ignored commands, property routing, and failed handler bookkeeping.
...
3. App version (v3.8.4+ logs include it automatically)
