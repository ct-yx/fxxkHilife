...
> **当前版本：v3.7.0**
> 优化电池卡水位视觉、未连接设备斜杠、详情页返回行为和后台初始化补齐节奏。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.7.0 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
