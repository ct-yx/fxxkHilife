...
> **当前版本：v3.8.2**
> 继续可插拔架构重构，新增 RfcommSppTransport，将 Android RFCOMM/SPP 原始连接与收发抽象为 Transport 层。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.8.2 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
