...
> **当前版本：v3.8.0**
> 新增听音统计页面：累计总时长、今日时长、已听天数、连续听音，并提供近 16 周活动热力图。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.8.0 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
