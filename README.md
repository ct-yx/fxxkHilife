...
> **当前版本：v3.5.1**
> 优化 GitHub Actions 构建与发布流程：分支仅构建产物，tag 校验版本一致后发布 Release，并自动提取 DEVELOPMENT_LOG 作为发布说明。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.5.1 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
