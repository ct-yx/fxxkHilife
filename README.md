...
> **当前版本：v3.8.3**
> 继续 4.0 架构前置重构，新增通用 Protocol 接口与 HuaweiSppProtocol / HuaweiSppFramer，将 5A 包编码和流式解帧抽象到协议层。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.8.3 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
