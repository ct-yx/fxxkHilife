...
> **当前版本：v3.3.0**
> 扩展 i18n 接口覆盖范围，主要用户界面文案已迁移到统一 key 表；日志页 / 调试终端保留原始中文排障文本，便于稳定定位问题。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.3.0 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
