...
> **当前版本：v3.5.0**
> 新增项目自绘「耳机 + 耳机盒」单色矢量图标，并应用到主页设备列表、扫描设备项、设备电量卡和设置页应用详情。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v3.5.0 起保留保守能力表以降低初始化压力，并暂时隐藏未确认可用的自动暂停选项；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
