...
- **v2.8.2 修复**：音质偏好首次切换后可及时同步；ANC 切换到通透后下方标题与选项显示为“通透模式”；权限引导页加入通知权限、后台保活与自启动设置入口。
...
| HUAWEI FreeBuds 7i | 临时保守适配，待完整适配 | v2.8.2 起加入保守能力表以降低初始化压力；完整适配会在下一轮大版本“更多型号/更多厂商耳机适配”中与测试者继续推进 |
