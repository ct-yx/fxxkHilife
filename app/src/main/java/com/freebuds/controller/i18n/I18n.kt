...
private object SimplifiedChineseProvider : I18nProvider {
    ...
    private val strings = mapOf(
        ...
        "settings.wallpaper_guide.title" to "壁纸可选",
        "settings.wallpaper_guide.text" to "液态玻璃自带彩色背景输入；选择壁纸可以进一步增强折射和层次，但不是开启条件。",
        ...
        "update.title" to "检查更新",
        "update.idle" to "尚未检查",
        "update.checking" to "检查中…",
        "update.up_to_date" to "已是最新版本",
        "update.available" to "发现新版本 %s",
        "update.available_desc" to "可以下载并在系统确认后安装。",
        "update.downloading" to "下载中…",
        "update.ready_to_install" to "已准备安装",
        "update.ready_to_install_desc" to "校验完成，交给 Android 系统确认安装。",
        "update.installing" to "正在打开系统安装器",
        "update.failed" to "更新失败",
        "update.current_version" to "当前版本 %s (%s)",
        "update.last_checked" to "上次检查：%s",
        "update.never_checked" to "从未检查",
        "update.release_metadata" to "渠道：%s · 发布：%s",
        "update.auto_check" to "后台自动检查",
        "update.auto_download" to "发现新版本后自动下载",
        "update.download" to "下载",
        "update.cancel" to "取消下载",
        "update.install" to "打开安装器",
        "update.check_now" to "立即检查",
        "update.open_release" to "打开 Release 页面",
...
private object EnglishProvider : I18nProvider {
    ...
    private val strings = mapOf(
        ...
        "settings.wallpaper_guide.title" to "Wallpaper is optional",
        "settings.wallpaper_guide.text" to "Liquid glass includes a built-in colour field. A wallpaper can add more refraction and depth, but it is not required.",
        ...
        "update.title" to "Check for updates",
        "update.idle" to "Not checked yet",
        "update.checking" to "Checking…",
        "update.up_to_date" to "You are up to date",
        "update.available" to "Update %s available",
        "update.available_desc" to "Download it and let Android ask for installation confirmation.",
        "update.downloading" to "Downloading…",
        "update.ready_to_install" to "Ready to install",
        "update.ready_to_install_desc" to "Validation passed; Android will confirm installation.",
        "update.installing" to "Opening the system installer",
        "update.failed" to "Update failed",
        "update.current_version" to "Current version %s (%s)",
        "update.last_checked" to "Last checked: %s",
        "update.never_checked" to "Never checked",
        "update.release_metadata" to "Channel: %s · Published: %s",
        "update.auto_check" to "Check in the background",
        "update.auto_download" to "Download updates automatically",
        "update.download" to "Download",
        "update.cancel" to "Cancel download",
        "update.install" to "Open installer",
        "update.check_now" to "Check now",
        "update.open_release" to "Open Release page",
